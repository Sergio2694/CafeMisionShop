...
<!--shop control-->
						...
						<ul class="row list-products auto-clear equal-container product-grid">
							...
							<?php
								...
								$result = mysql_query("select * from articulo where art_code <= 4")or die(mysql_error());
						...
						<div class="pagination clearfix style2">
							<div class="nav-link">
								<a href="gridproducts.php" class="page-numbers current">1</a>
								<a href="gridproducts-2.php" class="page-numbers ">2</a>
								<a href="gridproducts-2.php" class="page-numbers"><i class="icon fa fa-angle-right" aria-hidden="true"></i></a>
							</div>
						</div>
