...
<!--shop control-->
						...
						<!--page title-->
						<h3 class="custom_blog_title">Productos disponibles</h3>
							...
							<li class="product-item  col-lg-3 col-md-4 col-sm-6 col-xs-6 style-1">
								<div class="product-inner equal-element">
									...
									<div class="product-info">
										<h5 class="product-name product_title"><a href="#"><?php echo $f['art_name']; ?></a></h5>
										<div class="group-info">
											<div class="stars-rating"><div class="star-rating"><span class="star-5"></span></div><div class="count-star">(5)</div></div>
											<div class="price"><span><?php echo $f['art_costounitario']; ?></span></div>
										</div>
									</div>
									<div class="loop-form-add-to-cart">
										<form class="cart">
											...
											<div class="variations">
												<div class="variation">
													<label class="variation-label">Tamaño:</label>
													<div class="variation-value">
														<span><?php echo $f['art_medida']; ?></span>	
													</div>
												</div>
											</div>
										</form>
						...
						<div class="pagination clearfix style2">
							<div class="nav-link">
								<a href="gridproducts.php" class="page-numbers"><i class="icon fa fa-angle-left" aria-hidden="true"></i></a>
								<a href="gridproducts.php" class="page-numbers ">1</a>
								<a href="gridproducts-2.php" class="page-numbers current ">2</a>
							</div>
						</div>
