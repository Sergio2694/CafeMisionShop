...
<head>
	...
	<link rel=icon href='assets/img/2.jpg' sizes="32x32" type="image/jpg">

</head>
<body class="productsgrid-page">
	<!--block text top-->
	<div class="header-top-message">
		<i class="icon fa fa-bicycle" aria-hidden="true"></i>Te llevamos el producto hasta la puerta de tu casa.. <a href="#">₡2 500</a> Café Piyis
	</div>
	<!-- header -->
			...
			<div class="header-nav main-menu-wapper">
				<div class="container-wapper">
					<ul class="clone-main-menu turan-nav main-menu" id="menu-main-menu">
						<li class="menu-item">
							<a href="index.php" class="kt-item-title" title="Home">Home</a>
						</li>
						<li class="menu-item">
							<a href="gridproducts.php" class="kt-item-title" title="Shop">Productos</a>
						</li>
						<li class="menu-item">
							<a href="about.php" class="kt-item-title" title="About">About</a>
						</li>
						<li class="menu-item">
							<a href="blog.php" class="kt-item-title" title="About">Blog</a>
						</li>
					</ul>
				</div>
			</div>
				...
				<div class="col-lg-12">
					<div class="breadcrumb-trail breadcrumbs">
						<ul class="trail-items breadcrumb">
							...
							<li class="trail-item trail-end active">List Products Left Sidebar</li>
						</ul>
					</div>
				</div>
			</div>
...
<!--shop control-->
						<div class="shop-top-control">
							...
							<div class="wrap-topbar-filter ">
								<span class="title class-toggle">Filters <i class="fa" aria-hidden="true"></i></span>
							...
							<div class="grid-view-mode">
								...
								<div class="inner">
									<span class="title hidden" >Vista </span>
									<a href="listproducts.php" class="modes-mode mode-list active">
										<span></span>
										<span></span>
									</a>
									<a href="gridproducts.php" class="modes-mode mode-grid">
										<span></span>
										<span></span>
										<span></span>
										<span></span>
						...
						<!--page title-->
						<h3 class="custom_blog_title">#Lista de Productos</h3>
						...
						<ul class="row list-products auto-clear equal-container product-list">
							...
							<?php
								...
								$result = mysql_query("select * from articulo where art_code <= 5 and art_code <= 8 ")or die(mysql_error());
								...
								<div class="product-inner equal-element">
									...
									<div class="products-bottom-content">
										<div class="row">
											...
											<div class="product-thumb col-lg-3 col-md-4 col-sm-4 col-xs-6 ">
												<div class="thumb-inner">
													<a href="#">
														<img src="assets/img/<?php echo $f['art_foto']; ?>" alt="">
													</a>
												</div>
											</div>

											<div class="product-info-left col-lg-6 col-md-4 col-sm-4 col-xs-6 ">
												...
												<ul class="product-attributes">
													<li class="product-attr size-attr deault-separator">
														<b class="attr-name">Size:</b>
														<span class="attr-value"><?php echo $f['art_medida']; ?></span>
														
													</li>
												</ul>
											</div>

											<div class="product-info-right col-lg-3 col-md-4 col-sm-4 col-xs-6 ">
												<p class="price"><?php echo $f['art_costounitario']; ?></p>
												<span class="product-list-message"><i class="icon fa fa-bicycle" aria-hidden="true"></i>Envio Incluido</span>
												<form class="cart">
													<div class="single_variation_wrap">
														...
														<button class="single_add_to_cart_button button">Agregar al Carrito</button>
													</div>
												</form>
											</div>
						...
						<div class="pagination clearfix style2">
							<div class="nav-link">
								...
								<a href="listproducts.php" class="page-numbers current">1</a>
								<a href="listproducts-2.php" class="page-numbers ">2</a>
								<a href="listproducts-2.php" class="page-numbers"><i class="icon fa fa-angle-right" aria-hidden="true"></i></a>
							</div>
						</div>
				...
				<!-- full-width layout have no sidebar area-->
			</div>
						...
						<div class="box-footer col-xs-12 col-sm-6 col-md-6 col-lg-4">
							<div class="widget-box">
								<div class="single-img">
									<a href="index.html"><img src="assets/img/2.jpg" alt=""></a>
								</div>
								<div class="text-content-elememnt">
									<p>La tienda virtual de Café Misión Costa Rica tiene como fin, dar una mayor satisfacción al cliente sobre la adquisión de nuestros productos.</p>
								</div>
							</div>
						</div>
						...
						<div class="box-footer col-xs-12 col-sm-6 col-md-6 col-lg-4">
							<div class="turan-newsletter style1">
								<div class="newsletter-head">
									<h3 class="title">Subscribirse en la tienda</h3>
								</div>
								<div class="newsletter-form-wrap">
									<div class="list">
										<span class="text">Estoy interesado en la tienda:</span>
									
									</div>
									<input type="email" class="input-text email email-newsletter" placeholder="Introduce el correo">
									<button class="button btn-submit submit-newsletter">Suscribirse</button>
								</div>
							</div>
							<div class="turan-socials">
								<ul class="socials">
									<li><a href="#" class="social-item" target="_blank"><i class="icon fa fa-facebook-square"></i></a></li>
					...
					<div class="footer-end" style="text-align: center;">
						<div class="row" style="text-align: center;">
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" style="text-align: center;">
								<div class="coppyright" style="text-align: center;">Copyright © 2019 <a href="#">Café Misión Costa Rica</a>. All rights reserved</div>
							</div>
