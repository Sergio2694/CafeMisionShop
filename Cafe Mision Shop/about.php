				...
				<div class="content-area content-about col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="site-main">
						...
						<div class="page-main-content">
							<div class="header-banner banner-image header-banner-about">
								<div class="banner-wrap">
									<div class="banner-header">
										<div class="col-lg-5 col-md-offset-7">
											<div class="content-inner">
												<h2 class="title">
													Café Misión Costa Rica<br/>El mejor Café de Costa Rica &<br/>
												</h2>
												<div class="sub-title">
													Adquiera el mejor producto de Costa Rica
												</div>
												<a href="gridproducts.php" class="turan-button button">VEN Y COMPRA</a>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="team-member">
								...
								<h2 class="custom_blog_title center">Personas importantes en Café Misión</h2>
								<div class="team-member-slider nav-center owl-slick"  data-slick ='{"autoplay":false, "autoplaySpeed":1000, "arrows":true, "dots":false, "infinite":true, "speed":800, "rows":1}' data-responsive='[{"breakpoint":"400","settings":{"slidesToShow":1}},{"breakpoint":"530","settings":{"slidesToShow":2}},{"breakpoint":"767","settings":{"slidesToShow":3}},{"breakpoint":"991","settings":{"slidesToShow":3}},{"breakpoint":"1199","settings":{"slidesToShow":3}},{"breakpoint":"2000","settings":{"slidesToShow":3}}]'>
									<div class="turan-team-member">
										<div class="team-member-item">
											<div class="member_avatar">
												<img src="assets/img/e2.jpg" alt="">
											</div>
											<h5 class="member_name">Héctor Soto Rojas</h5>
											<div class="member_position">Gerente y Administrador de Café Misión</div>
										</div>
									</div>
									<div class="turan-team-member">
										<div class="team-member-item">
											...
											<h5 class="member_name">Daniel Montoya Salas</h5>
											<div class="member_position">Gerente y Administrador de Café Misión</div>
										</div>
									</div>
									<div class="turan-team-member">
										<div class="team-member-item">
											<div class="member_avatar">
												<img src="assets/img/e12.jpg" alt="">
											</div>
											<h5 class="member_name">Julián Araya Paniagua</h5>
											<div class="member_position">Ingeniero Agronómo de Café Misión</div>
										</div>
									</div>
